...
from screens.home import on_resize
...
menu_icon_path = "src/images/Style=bulk.png"
...
logo_path = "src/images/WebTV.png"
...
# Icône loupe
search_icon_path = "src/images/search.png"
...
btn_signup = tk.Button(buttons_frame, text="S'inscrire", bg="black", fg="white", font=("Arial", 10, "bold"), command=lambda: SignupPage(root.geometry()))
btn_signup.grid(row=0, column=0, padx=(0, 10))

profile_frame = tk.Frame(content_frame, bg="#F5F5F5")
profile_frame.grid(row=1, column=0, sticky='ew', padx=20, pady=20)

#A modifier avec le path  absolu qui est dans le sratch.py
# Profile Picture
profile_pic = create_image("src/images/user.png", (100, 100))
